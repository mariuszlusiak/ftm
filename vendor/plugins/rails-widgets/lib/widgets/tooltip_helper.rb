module Widgets
  module TooltipHelper
    ...
    def tooltip_content(opts={}, &proc)
     return render(:partial => opts[:partial], :object => opts[:object]) if opts[:partial]
     return capture(&proc)
    end
    ...
    def close_tooltip_link(id, message = 'zamknij')
      message ||= 'zamknij' # if nil is passed I'll force it
